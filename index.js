...
client.on('message', message => {
    ...
    if (message.content.toLowerCase().includes("günaydın")) {  
        message.react(`\<:zzzscrpionNNgunaydin:747436962545139772>`);
        message.react(`\<:pppKalp:746858083132637245>`);
    };

    if (message.content.includes(`\<:zzzscrpionNNgunaydin:747436962545139772>`)) {
        message.react(`\<:zzzscrpionNNgunaydin:747436962545139772>`);
        message.react(`\<:pppKalp:746858083132637245>`);
    };

    if (message.content.toLowerCase().includes("iyi geceler")) {  
        message.react(`\<:zzzscrpionNNiyigeceler:747468359314047007>`);
        message.react(`\<:pppKalp:746858083132637245>`);
    };

    if (message.content.includes(`\<:zzzscrpionNNiyigeceler:747468359314047007>`)) {
        message.react(`\<:zzzscrpionNNiyigeceler:747468359314047007>`);
        message.react(`\<:pppKalp:746858083132637245>`);
    };
...
client.on('ready', async() => {
    ...
    client.user.setActivity('SAHİBEM rhasst <3');
